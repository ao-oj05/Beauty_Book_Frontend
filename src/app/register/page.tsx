      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8">
        <div className="max-w-md w-full space-y-8">
          <div className="space-y-2">
            <h2 className="text-4xl font-semibold text-gray-900">Crear Cuenta</h2>
          ...
          <form className="space-y-5">
            ...
            <div className="space-y-1">
              <label className="text-sm font-medium text-gray-700 block">Teléfono</label>
              <input 
                type="tel" 
                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#ff4d6d]/20 focus:border-[#ff4d6d] transition-all"
            ...
            <Link href="/dashboard/client" className="block w-full text-center bg-[#ff4d6d] hover:bg-[#c9184a] text-white py-3.5 rounded-xl font-medium transition-colors mt-2">
              Crear Cuenta
            </Link>
          </form>

          <div className="text-center pt-2">
            <Link href="/login" className="text-[#ff4d6d] hover:text-[#c9184a] font-medium transition-colors">
